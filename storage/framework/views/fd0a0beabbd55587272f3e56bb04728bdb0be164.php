    ...
    <div class="tile">
      ...
      <div class="card">
        <div class="card-header">
          <form method="get" action="<?php echo e(route('repayment.index')); ?>">
            <div class="row">
      ...
      <div class="table-responsive resize-w">
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              <?php if(isAdmin() || Auth::user()->can('loan.pay')): ?>
              ...
              <tr>
                <td class="text-center">
                  ...
                  <div class="btn-group mr-2" role="group" aria-label="Second group">
                      ...
                      <a href="<?php echo e(route('repayment.show', [$loan->id, RepayType::REPAY])); ?>" class="btn btn-success btn-sm  mr-1 mb-1">
                ...
                <td><b>$ <?php echo e(decimalNumber($loan->total_amount - $loan->total_paid_amount, true)); ?></b></td>
                <td>
                  <b>
