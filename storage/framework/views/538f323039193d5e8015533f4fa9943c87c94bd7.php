...
<main class="app-content">
  <div class="tile">
    <!-- <?php echo e(PaymentScheduleType::EQUAL_PAYMENT); ?> -->
          ...
          <div class="row">
            ...
            <div class="col-lg-4 form-group">
              ...
              <select name="schedule_type" id="schedule_type" class="form-control select2 select2-no-search" required
                ...
                <option value="<?php echo e(PaymentScheduleType::DECLINE_INTEREST); ?>">
                  <?php echo e(trans('app.down_interest_payment')); ?>

                </option>
                <!-- <option value="<?php echo e(PaymentScheduleType::FLAT_INTEREST); ?>">
                  <?php echo e(trans('app.flat_interest')); ?>
