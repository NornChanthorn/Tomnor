        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-4 form-group">
              <label for=""><?php echo e(__("app.start_date")); ?></label>
              <input type="text" class="form-control date-picker" value="<?php echo e(displayDate(now())); ?>">
            </div>
            <div class="col-md-4 form-group">
              <label for=""><?php echo e(__("app.next_payment_date")); ?></label>
              <input type="text" class="form-control date-picker" value="<?php echo e(oneMonthIncrement(date('Y-m-d'))); ?>">
            </div>
            <div class="col-md-4 form-group">
