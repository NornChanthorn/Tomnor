<?php $__env->startSection('title', trans('app.supplier')); ?>

<?php $__env->startSection('content'); ?>
<main class="app-content">
  <div class="tile">
    <h3 class="page-heading"><?php echo e(trans('app.supplier')); ?></h3>
    ...
    <div class="table-responsive">
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td class="text-center"><?php echo e($offset++); ?></td>
            <td><?php echo e($supplier->contact_id); ?></td>
            <td><?php echo e($supplier->supplier_business_name); ?></td>
            <td><?php echo e($supplier->name); ?></td>
            <td><?php echo e($supplier->mobile); ?></td>
            <td><?php echo e(@$supplier->province->khmer_name ?? ''); ?></td>
            <td class="text-right">
              <?php echo $__env->make('partial/anchor-show', ['href' => route('contact.show', $supplier->id)], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
              <?php if($supplier->is_default == 0): ?>
                <?php if(isAdmin() || Auth::user()->can('supplier.edit')): ?>
                <a href="javascript::void(0);" class="btn btn-sm btn-primary mb-1 btn-modal" title="<?php echo e(trans('app.edit')); ?>" data-href="<?php echo e(route('contact.edit', $supplier->id)); ?>" data-container=".contact-modal">
                  <i class="fa fa-edit"></i>
                </a>
                <?php endif; ?>
                <?php if(isAdmin() || Auth::user()->can('supplier.delete')): ?>
                  <?php echo $__env->make('partial/button-delete', ['url' => route('contact.destroy', $supplier->id)], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php endif; ?>
              <?php endif; ?>
            </td>
          </tr>
...
<?php $__env->startSection('js'); ?>
  ...
  <script type="text/javascript">
    var contactExist = "<?php echo e(trans('message.supplier_already_exists')); ?>";
