    ...
    <form method="post" id="sale-form" class="validated-form no-auto-submit" action="{{ route('sale.save', SaleType::SALE) }}" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 form-group">
          ...
          <input type="text" name="sale_date" id="sale_date" class="form-control datepicker" required placeholder="{{ trans('app.date_placeholder') }}" value="{{ old('sale_date', displayDate($sale->sale_date)) ?? date('d-m-Y') }}">
        </div>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-lg-4 form-group">
              ...
              <input type="text" class="form-control" id="product" placeholder="{{ __('app.enter-product') }}" {{ old('branch', !empty(auth()->user()->staff) ? auth()->user()->staff->branch_id : null)=='' ? 'disabled' : '' }}>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12">
        ...
        <fieldset class="col-lg-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-12 form-group">
              ...
              <textarea name="note" id="note" rows="3" class="form-control" style="resize:none;">{{ old('note') }}</textarea>
            </div>
          </div>
        </fieldset>
      </div>
