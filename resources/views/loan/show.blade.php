                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            <div class="pull-right">
                                ...
                                @endif
                                @if ($loan->status=='ac')
                                    <a href="javascript::void(0);" class="btn btn-primary mb-1 btn-modal" title="{{ trans('app.delay_schedule') }}" data-href="{{ route('loan.ReSchedule', $loan) }}" data-container=".schedule_modal">
                                        {{ __('app.reschedule') }}
                                    </a>
                                @endif
